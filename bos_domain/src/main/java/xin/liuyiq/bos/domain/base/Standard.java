package xin.liuyiq.bos.domain.base;
...
@NamedQuery(name = "Standard.queryById2", query = "from Standard where id = ?")
public class Standard {
	...
	private Integer deleteFlag; // 删除收派标准 ,标记为1 的时候删除,null的时候显示
	...
	public String toString() {
		return "Standard [id=" + id + ", name=" + name + ", minWeight=" + minWeight + ", maxWeight=" + maxWeight
				...
				+ ", operator=" + operator + ", operatingCompany=" + operatingCompany + ", deleteFlag=" + deleteFlag
				+ "]";
	}
